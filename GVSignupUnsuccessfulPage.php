...
<head><title>Signup Unsuccessful</title>
...
<div class="MakeAccount">
    ...
    <p class="LoginTitle">Signup Unsuccessful</p>
    <p style="margin-left:20px">It seems there has been some problems with the sign up process. Please <a class="TextLink" href="GVSignUpPage.html">click here</a> to give it another try.</p>
</div>
