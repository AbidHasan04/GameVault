...
if(isset($error)){
        foreach ($error as $error) {
            echo '<p class= "PassText"><span>Sorry!</span>You left a box empty!</p>';
        }   
}
?>
<input type="Text" name="name" placeholder="eg. Niloy321" class="Name"><p class="NameText">Name</p>
<p style="display: inline-block; margin-left: 150px;">Address</p><input type="Text" name = "address" placeholder="eg. 22, Jump Street, Hollywood, USA" style="display: inline-block;"><br>
...
?>
<p style="margin-left: 20px; margin-bottom: 5px;">One more thing,</p>
<input type="Text" name="FavouriteGame" class="UserFaveGame"><p class="UserFaveGameText">Favourite Game?</p>
