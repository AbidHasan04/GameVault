...
<div class="ClickedGameDetails">    
    ...
    <p class="DetailName"><?php $sql = "SELECT ProdName FROM product WHERE ProdName = '$prodname';";
        ...
        ?></p>
    <p class="DetailRandom1">Specifications: <?php $sql = "SELECT Specifications FROM accessory WHERE AccName = '$prodname';";
        $result = mysqli_query($conn, $sql);
        $resultCheck = mysqli_num_rows($result);
        ...
        ?></p>
    <p class="DetailRandom1">Variations: <?php $sql = "SELECT Variations FROM accessory WHERE AccName = '$prodname';";
        $result = mysqli_query($conn, $sql);
        $resultCheck = mysqli_num_rows($result);
        ...
        ?></p>
    <p class="DetailRandom2">Quantity: <a class="ConsoleLink" style="color: aliceblue"><?php $sql = "SELECT HowMany FROM accessory WHERE AccName = '$prodname';";
        $result = mysqli_query($conn, $sql);
        $resultCheck = mysqli_num_rows($result);
        ...
        ?> <span class="NormalText"></span></a></p>
