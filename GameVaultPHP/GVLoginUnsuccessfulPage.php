...
<head><title>Login Unsuccessful</title>
...
<div class="MakeAccount">
    ...
    <p class="LoginTitle">Login Unsuccessful</p>
    <p style="margin-left:20px">It seems there has been some problems with the log in process. Please <a class="TextLink" href="GVLogInPage.html">click here</a> to try again.</p>
</div>
