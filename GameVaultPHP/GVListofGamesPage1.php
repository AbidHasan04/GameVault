...
<div class="ListContent" >   
    ...
    $select = "SELECT ImageLink FROM product WHERE ProductID = 3;";
...
<form action="GVGameDetailsPage.php" method="post">
    ...
    $select = "SELECT ProdName FROM product WHERE ProductID = 3;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ProdName'];
    ...
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 3;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
    ...
    $select = "SELECT Price FROM product WHERE ProductID = 3;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 3;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    $select = "SELECT Discount FROM product WHERE ProductID = 3;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 4;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 4;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 4;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 4;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 4;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 4;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 5;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 5;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 5;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 5;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 5;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 5;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
        $Discount5 = $row['Discount'];
    } 
    ?> </span></p>
            </div> </div> </div>
    ...
    $insert = "INSERT INTO orderlist(OrderName, OrderPrice, OrderDiscount,Username) VALUES('$ProdName5','$Price5','$Discount5','$name');";
                $res = mysqli_query($conn, $insert);
}
    ?>
         <form method= "post" class = "CartButton" style = "border-style: none;">   
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 6;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 6;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 6;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 6;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 6;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 6;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 7;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 7;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 7;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 7;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 7;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 7;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 8;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 8;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 8;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 8;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 8;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 8;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 9;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 9;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 9;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 9;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 9;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 9;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 10;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 10;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 10;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 10;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 10;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 10;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 11;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 11;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 11;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 11;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 11;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 11;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 12;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 12;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 12;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 12;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 12;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 12;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 13;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 13;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 13;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 13;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 13;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 13;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 14;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 14;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 14;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 14;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 14;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 14;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 15;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 15;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 15;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 15;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 15;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 15;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 16;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 16;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 16;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 16;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 16;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 16;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 17;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 17;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 17;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 17;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 17;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 17;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 18;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 18;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 18;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 18;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 18;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 18;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <p align = "center">Page:<span style = "text-decoration: underline;"> 1 </span><a href = 'GVListofGamesPage2.php'>2</a> <a href = 'GVListofGamesPage3.php'>3</a> <a href = 'GVListofGamesPage4.php'>4</a></p>
