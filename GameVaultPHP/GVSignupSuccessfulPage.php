...
if(isset($_POST['submit'])){
    ...
    if(mysqli_num_rows($res) >0){
        ...
        $sel = "SELECT Name FROM users WHERE Name = '$name';";
        $res = mysqli_query($conn, $select);
            ...
            $_SESSION['name']= $row['Name'];
                ...
                $error[] = 'Whoops, you dont have an account!';}
...
<head><title>Signup successful</title>
...
<div class="MakeAccount">
    ...
    <p class="LoginTitle">Signup Successful!</p>
    <p style="margin-left:20px">Your account has been created, now you can proceed with Logging in.</p><br>
...
} else {echo '<p class="Text">You can only download if youre logged in.</p>';}
?>
<form action="" method="post">
    <p class="NameText">Name</p><input type="Text" name="name" placeholder="Username" class="Name"><br>
