...
<div style="margin-top: 5px; margin-left: 5px; padding-bottom: 100px; border-radius: 20px; border-style: solid; border-width: 1px;">
<h2 style="margin-left: 10px; margin-top:20px">Logged Out</h2>
<?php
echo '
<p style="margin-left: 10px;">You are logged out ' .$NameIs.'. Hope you come by again!</p>
';
