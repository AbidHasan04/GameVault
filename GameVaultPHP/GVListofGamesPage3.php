...
<div class="ListContent" >   
    ...
    $select = "SELECT ImageLink FROM product WHERE ProductID = 67;";
...
<form action="GVGameDetailsPage.php" method="post">
    ...
    $select = "SELECT ProdName FROM product WHERE ProductID = 67;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ProdName'];
    ...
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 67;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
    ...
    $select = "SELECT Price FROM product WHERE ProductID = 67;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 67;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    $select = "SELECT Discount FROM product WHERE ProductID = 67;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 68;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 68;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 68;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 68;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 68;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 68;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 69;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 69;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 69;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 69;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 69;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 70;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 70;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 70;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 70;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 70;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 70;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 71;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 71;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 71;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 71;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 71;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 71;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 72;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 72;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 72;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 72;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 72;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 72;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 73;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 73;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 73;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 73;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 73;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 73;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 74;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 74;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 74;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 74;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 74;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 74;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 75;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 75;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 75;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 75;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 75;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 75;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 76;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 76;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 76;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 76;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 76;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 76;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 77;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 77;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 77;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 77;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 77;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 77;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 78;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 78;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 78;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 78;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 78;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 78;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 79;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 79;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 79;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 79;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 79;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 79;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 80;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 80;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 80;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 80;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 80;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 80;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 82;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 82;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 82;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 82;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 82;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 82;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
?>
    ...
    <div class="bbbox">
    <img class="Thumbnail" src="<?php
    $select = "SELECT ImageLink FROM product WHERE ProductID = 83;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['ImageLink'];
...
<input class="DetailName" type="submit" name="submitGame" value ="<?php
$select = "SELECT ProdName FROM product WHERE ProductID = 83;";
$res = mysqli_query($conn, $select);
if (mysqli_num_rows($res) > 0) {
$row = mysqli_fetch_assoc($res);
echo $row['ProdName'];
...
?>" >
            ...
            <div class="ParaSorting">
            <p class="TextSameLine">Genre: <?php
    $select = "SELECT Genre1, Genre2, Genre3 FROM game WHERE ProductID = 83;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Genre1'].", ".$row['Genre2'].", ".$row['Genre3'];
    ...
    ?></p>
            <p class="TextSameLine">Price: Tk <span class="DetailPrice"> <?php
    $select = "SELECT Price FROM product WHERE ProductID = 83;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Price'];
    ...
    ?> </span></p>
            ...
            <P class="TextSameLine">Console: <?php
    $select = "SELECT PlayedIn FROM game WHERE ProductID = 83;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['PlayedIn'];
    ...
    ?> </P>
            <p class="TextSameLine" >Discount: Tk <span class="DetailDiscounts"><?php
    $select = "SELECT Discount FROM product WHERE ProductID = 83;";
    $res = mysqli_query($conn, $select);
    if (mysqli_num_rows($res) > 0) {
        $row = mysqli_fetch_assoc($res);
        echo $row['Discount'];
...
<p align = "center">Page: <a href = 'GVListofGamesPage1.php'>1</a> <a href = 'GVListofGamesPage2.php'>2</a><span style = "text-decoration: underline;">  3</span> <a href = 'GVListofGamesPage4.php'>4</a></p>
</div>
