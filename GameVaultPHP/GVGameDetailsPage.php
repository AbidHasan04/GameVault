...
<div class="ClickedGameDetails">    
    ...
    <p class="DetailName"><?php $sql = "SELECT ProdName FROM product WHERE ProdName = '$prodname';";
        ...
        ?></p>
    <p class="DetailRandom1">Genres: <?php $sql = "SELECT Genre1, Genre2, Genre3 FROM game WHERE GameName = '$prodname';";
        $result = mysqli_query($conn, $sql);
        $resultCheck = mysqli_num_rows($result);
        ...
        ?></p>
    <p class="DetailRandom1">Number of Players: <?php $sql = "SELECT TotalPlayers FROM game WHERE GameName = '$prodname';";
        $result = mysqli_query($conn, $sql);
        $resultCheck = mysqli_num_rows($result);

        if ($resultCheck > 0) {
            $row = mysqli_fetch_assoc($result);
                echo $row['TotalPlayers'];
        }
        ?></p>
    <p class="DetailRandom2">Console: <span class="ConsoleLink" style="color: aliceblue"><?php $sql = "SELECT PlayedIn FROM game WHERE GameName = '$prodname';";
        $result = mysqli_query($conn, $sql);
        $resultCheck = mysqli_num_rows($result);
        ...
        ?><span class="NormalText">(Available)</span></span></p>
